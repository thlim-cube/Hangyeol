...
public final class IOKitManager: @unchecked Sendable {
    ...
    private var lastHangyeolToggleEnabled: Bool?
    ...
    public func start() -> Bool {
        ...
        lastHangyeolToggleEnabled = hangyeolToggleEnabled
    ...
    private func handleInputValue(_ value: IOHIDValue) {
        ...
        let hangyeolToggleEnabled = !config.capsLockInputSourceSwitchEnabled
        if lastHangyeolToggleEnabled != hangyeolToggleEnabled {
            lastHangyeolToggleEnabled = hangyeolToggleEnabled
            resetKeyState()
    ...
    static func bindingLimitations(
        ...
        let hanjaIsShadowedByToggle = hangyeolToggleEnabled
